...
var JointType;
(function (JointType) {
    JointType[JointType["Fixed"] = 0] = "Fixed";
    JointType[JointType["Roller"] = 1] = "Roller";
    JointType[JointType["Free"] = 2] = "Free";
})(JointType || (JointType = {}));
class Node {
    constructor(pos, type) {
        this._pos = new Vec2(0.0, 0.0);
        this._deform = new Vec2(0.0, 0.0);
        this._fApplied = new Vec2(0.0, 0.0);
        this._fReaction = new Vec2(0.0, 0.0);
        this.type = JointType.Free;
        this.orientation = 0; // Rotation in deg
        this._scale = 20.0;
        this.selected = false;
        this.drag = false;
        this.forcing = false;
